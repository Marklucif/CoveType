...
The production site is deployed by GitHub Actions to `https://covetype.com/`. Installer links point to the matching GitHub prerelease asset; installer archives are intentionally excluded from the source repository.
