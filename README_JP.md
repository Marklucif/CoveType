...
`dist/CoveType-2.1.4-macOS-AppleSilicon-Installer.zip` を展開し、`Install CoveType.command` を開いてください。インストーラは独立した Python/MLX 環境、モデル、ログイン項目、初期設定を構成します。マイクとアクセシビリティの許可は、macOS のシステム設定でユーザー本人が承認する必要があります。
